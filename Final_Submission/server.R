  ...
  isolate({
    withProgress(message = 'Loading required n-grams...',
                 detail = 'This may take a several seconds...', value = 0, {
                   unigramModelNews <- readRDS("E:/THE TUTORIALS/Shiny/newsNGrams/unigramModelReduced.rds")
                   incProgress(1/8)
                   bigramModelNews <- readRDS("E:/THE TUTORIALS/Shiny/newsNGrams/bigramModelReduced.rds")
                   incProgress(1/8)
                   trigramModelNews <- readRDS("E:/THE TUTORIALS/Shiny/newsNGrams/trigramModelReduced.rds")
                   incProgress(1/8)
                   fourgramModelNews <- readRDS("E:/THE TUTORIALS/Shiny/newsNGrams/fourgramModelReduced.rds")
                   incProgress(1/8)
                   unigramModelTwitter <- readRDS("E:/THE TUTORIALS/Shiny/twitterNGrams/unigramModelReduced.rds")
                   incProgress(1/8)
                   bigramModelTwitter <- readRDS("E:/THE TUTORIALS/Shiny/twitterNGrams/bigramModelReduced.rds")
                   incProgress(1/8)
                   trigramModelTwitter <- readRDS("E:/THE TUTORIALS/Shiny/twitterNGrams/trigramModelReduced.rds")
                   incProgress(1/8)
                   fourgramModelTwitter <- readRDS("E:/THE TUTORIALS/Shiny/twitterNGrams/fourgramModelReduced.rds")
                   incProgress(1/8)
                 })
  })
